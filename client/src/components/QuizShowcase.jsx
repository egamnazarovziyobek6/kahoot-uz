...
import { IconArrowRight, IconBook, IconBook2, IconHeadphones, IconLetterCase } from '@tabler/icons-react'
import { quizzes } from '../lib/characters.js'
import { fadeUp, stagger, inViewOnce } from '../lib/motion.js'

const ICONS = { book: IconBook, letters: IconLetterCase, headphones: IconHeadphones, bookOpen: IconBook2 }
        ...
        {quizzes.map((q) => {
          ...
          return (
            ...
            >
              ...
              >
                <Icon size={36} stroke={1.5} style={{ color: q.color }} />
              </div>
              <div className="p-5">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <a
                    href="#join"
                    className="inline-flex items-center gap-1 font-display text-sm font-extrabold"
                    style={{ color: q.color }}
                  >
                    O‘ynash
